...
define('DB_NAME', 'library'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'library'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
